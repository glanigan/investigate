...
<t:master>
    <jsp:attribute name="title">Load Application</jsp:attribute>
    <jsp:attribute name="pageheader">Load Submission</jsp:attribute>
        ...
        <form id="Appform" action="LoadApplication" method="POST">
            ...
            <div id="LoadFormBody">
                <label>Type:</label>
                    ...
                    <label>Number:</label>
                        <input name='telephoneNumber' type="text" maxlength="20"></input><br><br>
            </div>
            <header class="header">
                <h2>Bank Details</h2>
            </header>
